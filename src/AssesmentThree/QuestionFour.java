...
public class QuestionFour {
	...
	@Test//fourth test to be run
	public static void futureDateSelector() {
		driver.findElement(By.partialLinkText("Datepicker")).click();
		System.out.println("you are in the page:" + driver.getTitle());
		sleep(2);
