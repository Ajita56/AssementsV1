...
public class QuestionSeven4 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Message 1: " + alertMsg);
		...
		System.out.println("Message 2: " + alertMsg);
		sleep(3);//just to view the alert box
		driver.switchTo().alert().dismiss();
		alertMsg= driver.findElement(By.id("demo")).getText();
		System.out.println("Message 2: " + alertMsg);
		...
		alertMsg= driver.switchTo().alert().getText();
		System.out.println("Message 4: " + alertMsg);
		//enter data into text box
		driver.switchTo().alert().sendKeys("hello how are you doing!!!"); 
		sleep(3);//just to view the alert box
		driver.switchTo().alert().accept();
		alertMsg= driver.findElement(By.id("demo1")).getText();
		System.out.println("Message 2: " + alertMsg);
