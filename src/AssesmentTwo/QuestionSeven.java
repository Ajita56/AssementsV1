...
public class QuestionSeven {
	...
	public static void main(String[] args) {
		...
		driver.get(url);
		driver.findElement(By.id("btn2")).click();//skip sigh in
		driver.findElement(By.xpath("//a[text()='SwitchTo']")).click();//click on switch to 
		driver.findElement(By.xpath("//a[text()='Alerts']")).click();//select alerts
